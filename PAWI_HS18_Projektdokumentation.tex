...
\begin{figure}[h!]
	\center
	\includegraphics[scale=0.8]{BuildingPositioner.png}
	\caption{BuildingPositioner Interface}
\end{figure}
\begin{figure}
	\center
	\includegraphics[keepaspectratio, width=0.5\textwidth]{BuildingModel.png}
	\caption{Building Model Interface}
\end{figure}
\begin{figure}
	\center
	\includegraphics[keepaspectratio, width=0.5\textwidth]{Texturizer.png}
	\caption{Texturizer Interface}
\end{figure}
\begin{figure}
	\center
	\includegraphics[keepaspectratio, width=0.5\textwidth]{Rotator.png}
	\caption{Rotator Interface}
\end{figure}
\begin{figure}
	\center
	\includegraphics[keepaspectratio, width=0.5\textwidth]{MeanRingBuffer.png}

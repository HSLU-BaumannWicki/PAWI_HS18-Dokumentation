...
Um die Höhe anhand der Koordinaten zu errechnen wurde sowohl die OpenElevation wie auch die GoogleMaps API angesprochen. Beide unterstützen eine Abfrage über einen GET-Request und beide die gleiche Genauigkeit der Koordinaten, nämlich $0.000 001$ Grad. Was das Gradmass auf Meter übertragen bedeutet, wird in Tabelle \ref{tab:GradMeter} dargestellt. Dabei wird folgende Formel zu Hilfe genommen:
...
\includepdf[pages=-]{Rahmenplanung.pdf}

...
\begin{abstract}
	Das Ergebnis dieser Arbeit ist eine AR Applikation für Android SmartPhones. Diese Applikation wurde in 14 Wochen mit der Agilen Projektentwicklungsmethode erarbeitet. Sie gebraucht dabei eine klassische drei Schichten Architektur, mit Schnittstellen zu dem Kudan AR Framework und Höhen-REST-Schnittstellen. Bei einer Evaluation von Plattform wurde neben Smartphones auch die HoloLens in Betracht gezogen. Als AR Frameworks wurden Kudan, Vuforia und Wikitude, und andere betrachtet, und deren Vor- und Nachteile abgewogen, wobei man sich schliesslich für Kudan entschied. Es wurden verschiedene Prototypen zuerst mit Unity entwickelt, bis man sich im Verlauf des Projektes auf AndroidStudio festgelegt konnte. Diese Arbeit schildert sowohl den Entwicklungsprozess, wie auch die Spezifikationen und Funktionsweise des Systems. Die Durchführung einer Nutzerumfrage ergab die Markttauglichkeit der Applikation, andere Nutzungsmöglichkeiten und Verbesserungswünsche.
	
	Dem Leser werden wichtige Grundlagen der Augmented und Mixed Reality nähergebracht und einen historischen Überblick gewährt. Das Projekt leitete seine Anforderungen sowohl aus dem Projektbeschrieb, wie aus eigens erarbeiteten Vorgaben ab. Diese werden in einer Validierungsphase überprüft wobei von zehn Zielen, deren sieben erreicht wurden. Das Projekt schliesst mit einer Evaluierung der geleisteten Arbeit, Reflexion und Ausblick für die Zukunft. 
\end{abstract}
...
% TODO Gelernte Lektionen schreiben

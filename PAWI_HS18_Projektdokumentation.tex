...
In Phase 3 werden im User Centered Design werden zu beginn meist Prototypen auf Papier entwickelt, mit welchem sich der Benutzter durch die Applikation Navigieren kann. Diese Papier Prototypen sind für eine Dreidimensionale Applikation schwieriger zu gestalten und erschweren Dadurch den Prozess. Bedingt durch die Verkomplizierung, ist der ganze Ablauf des User Centered Design teurer und komplexer. (Zitiere something)


\subsection{Graphical User Interface}
Im Rahmen des User Centered Designs gibt es zudem Guidlines und verhaltensweisen des GUI.
Auch hier gilt, was bei Zweidimensionalen GUIs Funktioniert, muss nicht oder kann nicht auf einer AR Applikation verwendet werden.

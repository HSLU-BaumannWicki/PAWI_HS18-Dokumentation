...
Auf der Abbildung \ref{fig:FeatureBranchWorkflow} ist ein Auszug aus der Branch Struktur unserer Dokumentation. Dabei ist zu erkennen, dass zu Sprintbeginn möglichst keine Offenen Branches mehr vorhanden sind und gegen Sprint ende alle Brnaches in den Master (in Abbildung \ref{fig:FeatureBranchWorkflow} die Schwarze Linie) über einen pull request zusammengeführt werden.
\begin{figure}[h!]
	\center

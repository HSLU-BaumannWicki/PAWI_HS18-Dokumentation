...
Insgesamt wurden 4 Prototypen gebaut, von welchen 3 verworfen wurden.
Es wurde dabei jeweils 2 Mal das gleiche Konzept auf verschiedener Entwicklungsumgebungen aufgebaut. So wurde zuerst die Konzeptionelle Idee aus Kapitel \ref{ch:KonzeptionelleIdee} mit Unity entwickelt. Zudem wurde ein zweites Lösungskonzept (Siehe Kapitel \ref{ch:markerbasiertesLoesungskonzept} simultan zum gewählten entwickelt, welches wieder eingestellt wurde. Auch dieser Prototyp wurde zuerst mit Unity und anschliessend mit AndroidStudio entwickelt (Entscheidungsgründe dafür sind in Kapitel \ref{ch:evaluation} zu finden). 

...
Im Rahmen des User Centered Designs gibt es zudem Guidlines und verhaltensweisen des GUI.
Auch hier gilt, was bei Zweidimensionalen GUIs Funktioniert, muss nicht oder kann nicht auf einer AR Applikation verwendet werden. Um dem Benutzer die Interaktion mit der AR Applikation möglichst einfach und Intuitiv zu gestalten, müssen folgende Punkte mit Sicherheit beachtet werden.

\subsubsection{Prioritize screen real estate.}
\subsubsection{Make onboarding simple.}
\subsubsection{Keep it predictable.}
\subsubsection{Leave clues.}
\subsubsection{Design for a diverse set of users.}

...
\bigbreak
Ein Punkt, welchen wir für die Bachelorarbeit verbessern könnten, ist mit der Dokumentation früher im Projekt zu beginnen.  Die Dokumentation ist nicht erst während der letzten
Wochen entstanden, aber es gab viele Punkte, die bis zum Schluss nicht ganz klar und somit noch nicht dokumentiert waren.

Ein weiterer Punkt wäre, dass wir uns schneller auf eine Plattform und ein Framework beschränken hätten könne. Eine Eingrenzung hätte früher im Projekt eine Abgrenzung gesetzt und die Entwicklung des eigentlichen Prototypen fokussiert.

Für die Bachelorarbeit sind auf jeden Fall die Hilfsmittel (Trello, GitHub Organisation, Workflow, CI\&CD der Dokumentation) besser etabliert und können schon vor Beginn in Betrieb genommen werden, womit für die eigentliche Arbeit mehr Zeit zur Verfügung bleibt.

Wir haben auch den Aufwand für die Literaturrecherche und das Schreiben eines Stand der Forschung massiv unterschätzt, dieser Punkt wird für die nächste Arbeit sicher hohe Priorität am Anfang bekommen.

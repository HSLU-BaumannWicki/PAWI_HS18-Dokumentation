...
\begin{itemize}
	...
	\item Verbesserung der Nordinitialisation (Da dies das Ungenauste ist)
	\item Verbesserung der Höhenlogik mit OpenElevation
	\item Implementation einer GPS/SLAM Lösung (wodurch die Darstellungsgenauigkeit verbessert werden kann)

...
Auf der Abbildung \ref{fig:FeatureBranchWorkflow} ist ein Auszug aus der Baumstruktur unserer Dokumentation. Dabei ist zu erkennen, dass zu Sprintbeginn möglichst keine offenen Zweige mehr vorhanden sind und gegen Sprintende alle Zweige in den Master (in Abbildung \ref{fig:FeatureBranchWorkflow} die Schwarze Linie) über einen Pull Request zusammengeführt werden.
\begin{figure}[h!]
	\center

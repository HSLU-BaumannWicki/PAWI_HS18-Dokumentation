...
\begin{itemize}
	...
	\begin{itemize}
		\item eine maximale Abweichung von 10m auf einer minimalen Distanz von 50m bis mindestenz einer Distanz von 1km auf korrekter Position dargestellt werden (fortan korrekte Position genannt).
		...
		\item nach beendigung von mittelschnellen (>10km/s und <=20km/s) bewegungen wieder auf korrekter Position dargestellt werden.
	...
	\item Sofern keine Informationen zur Lokalisierung vorhanden sind soll der Benutzer in weniger als 3sec über dessen fehlen Informiert werden.
\end{itemize}

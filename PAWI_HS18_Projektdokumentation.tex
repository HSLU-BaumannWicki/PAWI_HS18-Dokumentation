...
Damit unsere Applikation funktioniert sind mehrere Teile nötig, in Abbildung \ref{fig:Komponentendesign} sind die wichtigsten schematisch dargestellt. Wir gebrauchen neben den dargestellten natürlich auch ein Betriebsystem (und dazugehörende Komponenten wie Speichermanagement und weiteres), aus Gründen der Übersichtlichkeit sind diese jedoch nicht aufgeführt.

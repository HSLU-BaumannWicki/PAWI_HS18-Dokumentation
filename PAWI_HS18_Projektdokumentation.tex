...
Aus der Problemstellung wird klar, dass neben der Evaluation von Plattformen auch eine zu den Geräten passende Art der Visualisierung erarbeitet werden muss. Wir hatten schon früh im Projekt die Vision, dass unsere Arbeit nicht nur für dieses Projekt einen Nutzen haben soll, sondern auch der Gesellschaft. So stellten wir uns vor, dass beispielsweise bei Projektausschreibungen in Dörfern nicht nur die Dimensionen der Neubauten abgesteckt sind, sondern dass auch für die Bevölkerung ein Mittel zur Verfügung gestellt wird, den geplanten Neubau mittels Augmented Reality auf dem Grundstück zu sehen. 

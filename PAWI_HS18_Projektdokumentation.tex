...
\chapter{Einleitung}
Diese Arbeit hat sich zum Ziel gesetzt einen Prototypen für eine Augmented Reality Applikaiton zu entwickeln, welche es ermöglicht Neubauten virtuell dem Benutzer auf einem reelen Grundstück darzustellen.

Im ersten Teil werden die technologischen Grundlagen und historischen Hintergründe der Arbeit erläutert. Danach wird die erarbeite Lösung vorgestellt und deren Funktionsweise dargestellt, im gleichen Kapitel wird auch geschildert welche Prototypen aus welchem Grund verworfen wurden. Es folgt ein Kapitel über die Durchführung des Projektes und wie dieses geplant wurde, unter anderem wie die verschiedenen Projektrahmenbedingungen evaluiert und gewählt wurden. Im darauffolgenden Kapitel folgt eine Detailbeschreibung des Systems und dessen interne Architektur.

Es folgt ein Kapitel über Testdesign, Testplanung und Durchführung. Danach in der Evaluation und Validation des Projektes die Durchführung einer Nutzerumfrage und Analyse derer. Nach der Validation folgt die Reflektion und ein Ausblick auf die zukünftige Entwicklung.

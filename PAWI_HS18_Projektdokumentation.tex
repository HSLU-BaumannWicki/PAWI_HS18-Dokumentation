...
In Phase 3 werden im User Centered Design werden zu beginn meist Prototypen auf Papier entwickelt, mit welchem sich der Benutzter durch die Applikation Navigieren kann. Diese Papier Prototypen sind für eine Dreidimensionale Applikation schwieriger zu gestalten und erschweren Dadurch den Prozess. Bedingt durch die Verkomplizierung, ist der ganze Ablauf des User Centered Design teurer und komplexer (\cite{ISO9241}).

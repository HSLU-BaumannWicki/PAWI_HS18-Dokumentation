...
Die eigentliche Erkennung der Marker geschieht mit Algorithmen der Computer Vision (Kantenerkennung, Eckenerkennung), worauf ein erkannter Marker mit einer Datenbank von bekannten abgeglichen wird. Damit kann über einen einzelnen Marker sowohl Positionierung wie auch Lokalisation geschehen.
